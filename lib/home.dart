...
// ---> NEW: Import the View Comments Page for the bottom sheet
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                // ---> UPDATED: Bottom Sheet Trigger for Comments <---
                IconButton(
                  icon: const Icon(Icons.chat_bubble_outline, size: 26),
                  onPressed: () {
                    showModalBottomSheet(
                      context: context,
                      isScrollControlled: true, // Required for DraggableScrollableSheet to expand
                      backgroundColor: Colors.transparent, // Prevents white corners behind the rounded sheet
